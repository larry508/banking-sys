...
from views.customer.utils import get_customer_details_prefill, update_address_from_form, update_contact_from_form, update_customer_from_form
...
def details():
    if request.method == 'GET':
        ...
        return render_template('customer/details.html', prefill=prefill, messages=messages, context=get_default_context())
    ...
    if request.method == 'POST':
        ...
        return render_template('customer/details.html', prefill=get_customer_details_prefill(address, contact, customer), messages=messages, context=get_default_context())
